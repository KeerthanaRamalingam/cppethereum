...
#include "genesis/eurekacoinMainNetwork.cpp"
...
#include "genesis/test/eurekacoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::eurekacoinMainNetwork: return c_genesisInfoEurekacoinMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::eurekacoinTestNetwork: return c_genesisInfoEurekacoinTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::eurekacoinMainNetwork: return c_genesisStateRootEurekacoinMainNetwork;
    case Network::eurekacoinTestNetwork: return c_genesisStateRootEurekacoinTestNetwork;
